--[[ KRYZEL HUB - Main Game Script ]]
-- Roblox Place Script for Kryzel Collection Hub
-- Red Color Scheme Theme
...
local function createMainUI(player)
	...
	print("Kryzel Hub UI Created Successfully!")
end
...
print("Kryzel Hub Script Loaded!")
